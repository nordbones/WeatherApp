...
class WeatherRepositoryImpl(private val client: KtorClient) : WeatherRepository {
    override suspend fun getWeather(longitude: Double,latitude: Double, ): Flow<ResultWrapper<WeatherDTO>> =
        flow {
            emit(
